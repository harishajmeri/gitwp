...
?>
	<?php if( $is_own_dashboard ) { ?>
	<h3 class="dashboard-none"><?php echo __( 'You have no events at this time. ', APP_TD) . html_link( va_get_event_create_url(), __( 'Click Here', APP_TD ) ) . __( ' to add an Event now.', APP_TD ); ?></h3>
	<?php } else { ?>
