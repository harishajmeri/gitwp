<div id="main">
	...
	<div class="claim-listing">
        ...
        <p><?php _e( 'If you are the owner to this business, you may proceed with claiming this listing by ', APP_TD ); ?><?php echo html_link( APP_Login::get_url( '', va_get_listing_purchase_url( $listing->ID ) ), __( 'Logging in', APP_TD ) );
