...
function va_install_widget( $widget_name, $sidebar, $instance_settings = array(), $instance_key = 1, $position = 'append' ) {
	...
	if ( array_key_exists( $instance_key, $settings ) ) {
		$instance_key++;
		return va_install_widget( $widget_name, $sidebar, $instance_settings, $instance_key, $position );
	}
