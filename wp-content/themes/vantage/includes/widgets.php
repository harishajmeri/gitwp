...
class VA_Widget_Listing_Map extends WP_Widget {
	...
	function enqueue_styles() {
		...
		wp_enqueue_style(
			'va-print-directions',
			get_template_directory_uri() . "/styles/google-directions-print.css",
			array(),
			VA_VERSION,
			'print'
		);
	...
	function widget( $args, $instance ) {
		...
		if ( $directions ) {
			...
			$html .= html( 'input', array( 'type' => 'button', 'id' => 'print_directions', 'onClick'=> 'window.print();', 'value' => __( 'Print Directions', APP_TD ) ) );
